...
byte lastString[] = {};
byte isZero[] = {0x11, 0x12, 0x13, 0x14, 0x15};
char isOn[] = {0x12, 0x13, 0x14, 0x15, 0x16};
void setup() {
  Serial.begin(9600);
  EEPROM.begin(512);
...
void serial_chk() {
  while (Serial.available()) {
    ...
    if (!valIsSame) {
      ...
      char switchData[] = {lastString[11], lastString[23], lastString[35], lastString[47], lastString[59]};
      for (int n = 0; n < 8; n++) {
