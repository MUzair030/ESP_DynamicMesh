...
void setup() {
  ...
  ledState1 = LOW;
  ledState3 = LOW;
  pinMode(TouchInput1, INPUT);
  pinMode(TouchInput3, INPUT);
}
...
void touch() {
  pinMode(TouchInput1, INPUT);
  pinMode(TouchInput3, INPUT);
  //  Serial.println("Touch Loop");
  int reading1 = digitalRead(TouchInput1);
  if (reading1 != lastButtonState1) {
    lastDebounceTime1 = millis();
    //    Serial.println("Step 1");
  }
  if ((millis() - lastDebounceTime1) > debounceDelay && (millis() - lastDebounceTime1) < longPress_10 && reading1 != buttonState1) {
    buttonState1 = reading1;
    if (buttonState1 == LOW) {
      ledState1 = !ledState1;
      digitalWrite(LED_relay1, ledState1);
      //      String bTrack = "@" + myID + "," + "T2" + "," + ledState2;
      if (ledState1 == LOW && ledState3 == LOW) {
        String bTrack = "00000000";
        sendBackTrack(bTrack);
      }
      else if (ledState1 == HIGH && ledState3 == LOW) {
        String bTrack = "10000000";
        sendBackTrack(bTrack);
      }
      else if (ledState1 == LOW && ledState3 == HIGH) {
        String bTrack = "01000000";
        sendBackTrack(bTrack);
      }
      else if (ledState1 == HIGH && ledState3 == HIGH) {
        String bTrack = "11000000";
        sendBackTrack(bTrack);
      }
    }
  }
  ...
  //#############################################################
  int reading3 = digitalRead(TouchInput3);
  if (reading3 != lastButtonState3) {
    lastDebounceTime3 = millis();
  }
  if ((millis() - lastDebounceTime3) > debounceDelay && (millis() - lastDebounceTime3) < longPress_10 && reading3 != buttonState3) {
    buttonState3 = reading3;
    if (buttonState3 == LOW) {
      ledState3 = !ledState3;
      digitalWrite(LED_relay3, ledState3);
      //      String bTrack = "@" + myID + "," + "T2" + "," + ledState2;
      if (ledState1 == LOW && ledState3 == LOW) {
        String bTrack = "00000000";
        sendBackTrack(bTrack);
